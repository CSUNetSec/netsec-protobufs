...
type IPFlow struct {
	...
	PhysicalPortNumber []int32 `protobuf:"varint,17,rep,packed,name=physical_port_number,json=physicalPortNumber,proto3" json:"physical_port_number,omitempty"`
...
type FlowRecord struct {
	...
	NumberOfAggregatedFlows int64 `protobuf:"varint,10,opt,name=number_of_aggregated_flows,json=numberOfAggregatedFlows,proto3" json:"number_of_aggregated_flows,omitempty"`
...
type CaptureRecordUnion struct {
	...
	RecordType           CaptureRecordUnion_RecordType `protobuf:"varint,2,opt,name=record_type,json=recordType,proto3,enum=netbrane.CaptureRecordUnion_RecordType" json:"record_type,omitempty"`
...
func (m *CaptureRecordUnion) XXX_DiscardUnknown() {
	xxx_messageInfo_CaptureRecordUnion.DiscardUnknown(m)
}

var xxx_messageInfo_CaptureRecordUnion proto.InternalMessageInfo
